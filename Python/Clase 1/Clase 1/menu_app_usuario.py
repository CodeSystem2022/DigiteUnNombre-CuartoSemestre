...
while opcion != 5:
  ...
  if opcion ==1:
      ...
      log.info(f'Usuario actualziado:{usuario_actualizado}')

  elif opcion == 4:
id_usuario_var = int(input('Digite el id del usuario a elimiar:'))
usuario = Usuario(id_usuario = id_usuario_var)
usuario_elimando = UsuarioDAO.eliminar(usuario)
lof.info(f'usuario eliminado: {usuario_elimando}')
